...
public class CEOPanelFormController {
    public Label lblDay;
    ...
    public void btnFinanceOnACtion(ActionEvent actionEvent) throws IOException {
        option = 1;
       // Navigation.navigate(Routes.CEODASHBOARD, pane);
    ...
    public void btnStoresOnAction(ActionEvent actionEvent) throws IOException {
        option = 2;
        Navigation.navigate(Routes.CEODASHBOARD, pane);
    }
    ...
    public void btnSuppliersOnACtion(ActionEvent actionEvent) throws IOException {
        ...
        InputStream inputStream = this.getClass().getResourceAsStream("/lk/ijse/spicesystem/report/supplier.jrxml");
